...
$(document).ready(function() {
    ...
    $('#add-contact-item').on( 'click', function (e) {
        ...
        userDataTable.row.add( [
            ...
            '<a data-toggle="modal" data-target="#EditContactModal" class="primary edit mr-1"><i class="fas fa-pencil-alt"></i></a>'+
                '<a class="danger delete mr-1"><i class="fas fa-trash-alt"></i></a>'+
                '<span class="dropdown">'+
