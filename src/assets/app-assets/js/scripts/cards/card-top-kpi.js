            ...
            var customBrowerChartOptions = {
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        { name: '2019-06-01', symbol: 'emptyStar2', symbolSize: 8 },
                        '2019-07-01', '2019-08-01', '2019-09-01', '2019-10-01', '2019-11-01',
                        { name: '2019-12-01', symbol: 'star2', symbolSize: 8 }
                    ],
                    label: {
                ...
                options: [
                    {
                        ...
                        legend: {
                            x: 'left',
                            orient: 'vertical',
                            data: ['KPI No.1', 'KPI No.2', 'KPI No.3', 'KPI No.4', 'KPI No.5', 'KPI No.6', 'KPI No.7', 'KPI No.8', 'KPI No.9', 'KPI No.10', 'KPI No.11', 'KPI No.12', 'KPI No.13', 'KPI No.14', 'KPI No.15', 'KPI No.16'],
                            textStyle: {
                                color: '#FFF'
                            },
                        },
                        ...
                        series: [{
                            ...
                            radius: '60%',
                            data: [
                                { value: idx * 128 + 80, name: 'KPI No.1' },
                                { value: idx * 64 + 160, name: 'KPI No.2' },
                                { value: idx * 32 + 320, name: 'KPI No.3' },
                                { value: idx * 16 + 640, name: 'KPI No.4' },
                                { value: idx++ * 8 + 1280, name: 'KPI No.5' },
                                { value: idx * 128 + 80, name: 'KPI No.6' },
                                { value: idx * 64 + 160, name: 'KPI No.7' },
                                { value: idx * 32 + 320, name: 'KPI No.8' },
                                { value: idx * 16 + 640, name: 'KPI No.9' },
                                { value: idx++ * 8 + 1280, name: 'KPI No.10' },
                                { value: idx * 128 + 80, name: 'KPI No.11' },
                                { value: idx * 64 + 160, name: 'KPI No.12' },
                                { value: idx * 32 + 320, name: 'KPI No.13' },
                                { value: idx * 16 + 640, name: 'KPI No.14' },
                                { value: idx++ * 8 + 1280, name: 'KPI No.15' },
                                { value: idx * 128 + 80, name: 'KPI No.16' }
                            ],
                            itemStyle: {
                                normal: {
                                    label: {
