...
(function (window, document, $) {
  ...
  var dataLevel = [
    { id: 0, text: '-- เลือก --' },
    { id: 1, text: 'ปฏิบัติงาน' },
    { id: 2, text: 'หัวหน้าปฏิบัติงาน' },
    { id: 3, text: 'ผู้จัดการ' },
    { id: 4, text: 'ผู้บริหาร' }
  ];
  ...
  $(".select2-data-unit").select2({
    data: dataUnit
  });

  $(".select2-data-depart").select2({
    data: dataDepart
  });

  $(".select2-data-level").select2({
    data: dataLevel
  });

  $(".select2-data-location").select2({
    data: dataLocation
  });

  $(".select2-data-groupjob").select2({
    data: dataGroupjob
  });

  $(".select2-data-status").select2({
    data: dataStatus
  });
