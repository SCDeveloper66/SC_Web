...
@Component({
  selector: 'app-import-activity-point',
  templateUrl: './import-activity-point.component.html',
  styleUrls: ['./import-activity-point.component.scss']
})
export class ImportActivityPointComponent implements OnInit {
  token;
  currentUser: any;
  fileId;
